...
<html>
    <head>
        ...
        <style type="text/css">
            nav{background-color:#EED6C4;}
            .pagination li.active {background-color:#EED6C4;}
    ...
    <body>
                ...
                <div class="col m12">
                    ...
                    <div class="row">
                        ...
                        <div class="col s6 input-field right">
                            ...
                            ?>
                        <button class="btn black darken-4 z-depth-3" title="Search" type="submit"><i class="fa fa-search"></i></button>
                      </div>
                    </div><!-- End of Row -->
                    </div>
                </form>
                        ...
                        <a href="<?php echo site_url('pembanding/read/'.$pembanding->id); ?>" target="_blank" class="white-text tooltip" data-position="bottom" data-tooltip="Click untuk mellihat lebih detil"> 
                            ...
                            <span class="right">
                                <?php
                                        ...
                                        echo anchor(site_url('pembanding/delete/'.$pembanding->id),'<class="tooltip" title="Delete"><i class="material-icons red-text">delete</i>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                                    ?>
                            </span>
                            </small>
                        </div><!-- /.card-content -->    
        ...
        <div class="row">
            <div class="col s12 right">
                <a href="#" class="btn black darken-4 z-depth-3">Total Record : <?php echo $total_rows ?></a>
        		<?php echo $pagination ?>
	       </div>
        </div>
    </body>
