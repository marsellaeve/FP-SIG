...
<body>
    ...
    <div class="row navbar-fixed">
        <nav>
            <div class="nav-wrapper <?php if(isset($color)){echo $color;}else{echo 'blue darken-2';} ?> z-depth-2">
              ...
              <li><a href="<?php echo site_url('peta'); ?>" class="brand-logo waves-effect"><i class="material-icons prefix white-text">room</i> Sistem Info Harga Tanah/Bangunan </a></li>
              </ul>
              <ul id="nav-mobile" class="right hide-on-med-and-down">
                <li><a href="<?php echo base_url('pembanding/create/1/1'); ?>">Tambah</a></li>
                </li>
              </ul>
    ...
    <footer class="page-footer black darken-4 z-depth-2">
          <div class="footer-copyright">
            <div class="container">
                    <strong class="left white-text">Evelyn Tjitrodjojo 05111840000099</strong>
            <a href="#" title="Top" alt="Top"><span class="right"><i class="material-icons white-text">expand_less</i></span></a>
            </div>
          </div>
